...
public class CreateIndividualActivityRequest {
    ...
    public CreateIndividualActivityRequest(String nombre, String descripcion, Integer idAmbitoSuperior, Integer idActividadSuperior, Date fechaInicio, Date fechaFin)
    {
        super();
