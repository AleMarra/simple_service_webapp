...
public class ChangePassword {
    ...
    @XmlElementRef(name = "authToken", namespace = "http://wtp", type = JAXBElement.class, required = false)
    protected JAXBElement<String> authToken;
    @XmlElementRef(name = "oldPassword", namespace = "http://wtp", type = JAXBElement.class, required = false)
    protected JAXBElement<String> oldPassword;
    @XmlElementRef(name = "newPassword", namespace = "http://wtp", type = JAXBElement.class, required = false)
    protected JAXBElement<String> newPassword;
    @XmlElementRef(name = "userId", namespace = "http://wtp", type = JAXBElement.class, required = false)
