...
package com.fiuba.taller.wtp.SecurityServicews;
...
public class RegisterUser {
    ...
    @XmlElementRef(name = "args0", namespace = "http://wtp", type = JAXBElement.class, required = false)
    protected JAXBElement<String> args0;
    @XmlElementRef(name = "args1", namespace = "http://wtp", type = JAXBElement.class, required = false)
    protected JAXBElement<String> args1;
    @XmlElementRef(name = "args2", namespace = "http://wtp", type = JAXBElement.class, required = false)
    protected JAXBElement<String> args2;
    @XmlElementRef(name = "args3", namespace = "http://wtp", type = JAXBElement.class, required = false)
    protected JAXBElement<String> args3;
    @XmlElementRef(name = "args4", namespace = "http://wtp", type = JAXBElement.class, required = false)
    protected JAXBElement<String> args4;
    @XmlElementRef(name = "args5", namespace = "http://wtp", type = JAXBElement.class, required = false)
    protected JAXBElement<String> args5;
    @XmlElementRef(name = "args6", namespace = "http://wtp", type = JAXBElement.class, required = false)
