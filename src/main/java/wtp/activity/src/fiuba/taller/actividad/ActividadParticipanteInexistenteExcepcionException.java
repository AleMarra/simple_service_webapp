...
public class ActividadParticipanteInexistenteExcepcionException extends java.lang.Exception{
    ...
    private static final long serialVersionUID = 1386934718092L;
    
    private wtp.activity.src.fiuba.taller.actividad.ActividadStub.ActividadParticipanteInexistenteExcepcion faultMessage;
    ...
    public void setFaultMessage(wtp.activity.src.fiuba.taller.actividad.ActividadStub.ActividadParticipanteInexistenteExcepcion msg){
       faultMessage = msg;
    }
    
    public wtp.activity.src.fiuba.taller.actividad.ActividadStub.ActividadParticipanteInexistenteExcepcion getFaultMessage(){
       return faultMessage;
    }
}
